...
describe('Category Model', function() {
	...
	describe('Saving', function() {
		...
		it('throws validaton error when name longer than 15 chars', function(done) {
			var category = new Category({
		...
		it('throws validaton error for duplicte category name', function(done) {
			var category = new Category({
				name: 'Beverages'
			});
			...
			category.save(function(err) {
				...
				var duplicte = new Category({
					name: 'Beverages'
				});

				duplicte.save(function(err) {
